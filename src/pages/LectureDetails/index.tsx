...
import { deleteLecture, fetchLectureById, fetchLectureParticipants, participateInLecture, unParticipateInLecture, viewLecture } from "../../api/lecture";
...
function LectureDetails () {
  ...
  const participateMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setSuccessMessage("Você receberá em seu email informações sobre a palestra!");
    },
    onError: (error) => {
        ...
        <div className="max-w-6xl w-full bg-white shadow-md rounded-lg p-6">
          ...
          <div className="flex flex-col md:grid md:grid-cols-2 md:gap-6">
            ...
            <div className="md:mb-0">
              <img className="object-cover w-full h-full rounded-lg" src={lecture.imageUrl} onError={(e) => e.currentTarget.src = "/images/heroBanner.png"} alt="Imagem de capa da palestra" />
            </div>

            <div className="flex flex-col">
              <h1 className="text-3xl font-bold mb-4 md:mb-2">{lecture?.title}</h1>
